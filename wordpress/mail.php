...
if (($confirmDsp == 0 || $sendmail == 1) && $empty_flag != 1) {
  ...
  <head>
    ...
    <script>
      ...
      gtag('config', 'UA-75074109-2');
    </script>

    <meta charset="utf-8"/>
    <meta name="Description" content="open town のホームページ"/>
    <meta name="keywords" content="opentown,sendai,design">

    <meta property="og:title" content="open town">
    <meta property="og:description" content="open town のホームページ">
    ...
    <link rel="stylesheet" href="/wp-content/themes/opentown/assets/css/app.css">
    <link href="https://fonts.googleapis.com/css?family=Alegreya+Sans+SC:300" rel="stylesheet">
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet"
          integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
    <script src="/wp-content/themes/opentown/assets/js/jquery-3.2.1.min.js"></script>
  </head>
  <body>
  <header>
    <div class="header">
      ...
      <ul>
        <li><a href="/#about"><img src="/wp-content/themes/opentown/assets/img/about.svg" alt="" width="68px"><span></span></a></li>
        <li><a href="/works"><img src="/wp-content/themes/opentown/assets/img/work.svg" alt="" width="64px"></a></li>
        <li><a href="/#service"><img class="header_service" src="/wp-content/themes/opentown/assets/img/service.svg" alt=""></a></li>
        <li><a href="/company"><img class="header_company" src="/wp-content/themes/opentown/assets/img/company.svg" alt=""></a></li>
        <li><a href="/contact"><img src="/wp-content/themes/opentown/assets/img/contact.svg" alt=""></a></li>
      </ul>
    </div>
  </header>
  <!-- 開閉用ボタン -->
  ...
  <nav class="menu sp" id="js__nav">
    <ul>
      <li><a href="#about"><img class="" src="/wp-content/themes/opentown/assets/img/about_w.svg" alt=""></a></li>
      <li><a href="/works"><img class="" src="/wp-content/themes/opentown/assets/img/work_w.svg" alt="" ></a></li>
      <li><a href="#service"><img class="" src="/wp-content/themes/opentown/assets/img/service_w.svg" alt="" ></a></li>
      <li><a href="/company"><img class="" src="/wp-content/themes/opentown/assets/img/company_w.svg" alt="" ></a></li>
      <li><a href="/contact"><img class="" src="/wp-content/themes/opentown/assets/img/contact_w.svg" alt="" ></a></li>
    </ul>
  </nav>
  ...
  <div class="wrapper">
    <div id="formWrap">
      ...
      <?php }else{ ?>
      <h2 class="fs20 mb20">確認画面</h2>
      <p class="mb30 underline" align="center">以下の内容で間違いがなければ、「送信する」ボタンを押してください。</p>
      <form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
        ...
        <p align="center"><input type="hidden" name="mail_set" value="confirm_submit">
          ...
          <input class="button" type="button" value="前画面に戻る" onClick="history.back()"></p>
      </form>
    </div>
    <?php } ?>
  </div><!-- /formWrap -->
...
if (($jumpPage == 0 && $sendmail == 1) || ($jumpPage == 0 && ($confirmDsp == 0 && $sendmail == 0))) {
  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>open town</title>
    <link rel="stylesheet" href="/wp-content/themes/opentown/assets/css/app.css?1">
    <link href="https://fonts.googleapis.com/css?family=Alegreya+Sans+SC:300" rel="stylesheet">
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet"
          integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
    <script src="/wp-content/themes/opentown/assets/js/jquery-3.2.1.min.js"></script>
...
<div class="wrapper">
  ...
  <?php } else { ?>
    <div class="mail-thanks">
      <p>送信ありがとうございました。</p>
      <p>送信は正常に完了しました。</p>
      <img src="/wp-content/themes/opentown/assets/img/icon/contact.gif" alt="">
      <a class="button back-top" href="<?php echo $site_top; ?>">トップページへ戻る&raquo;</a>
    </div>
    </div>
    </div>
    <?php copyright(); ?>
